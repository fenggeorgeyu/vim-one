...
function! airline#themes#one#refresh()
  ...
  let s:I3 = s:N3
  "---normal--- 
  "switch color N1 and I1
  let g:airline#themes#one#palette.normal = airline#themes#generate_color_map(s:I1, s:N2, s:N3)
  let group = airline#themes#get_highlight('vimCommand')
  let g:airline#themes#one#palette.normal_modified = {
        \ 'airline_c': [ group[0], '', group[2], '', '' ]
        \ }
  "---insert---
  let g:airline#themes#one#palette.insert = airline#themes#generate_color_map(s:N1, s:I2, s:I3)
  let g:airline#themes#one#palette.insert_modified = g:airline#themes#one#palette.normal_modified
  "---replace---
